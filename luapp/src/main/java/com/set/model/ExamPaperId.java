...
@Embeddable
public class ExamPaperId implements Serializable {
	   /**
	 * 
	 */
	...
	public ExamPaperId(String questionId, String examId, int questionNumber) {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof ExamPaperId))
			return false;
		ExamPaperId that = (ExamPaperId) o;
