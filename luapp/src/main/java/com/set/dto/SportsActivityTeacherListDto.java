...
public class SportsActivityTeacherListDto implements Serializable {
	/**
	 * 
	 */
	...
	private List<SportsActivityTeacherDto> SportsDatas;
	//private int Count;
...
//		this.Count = count;
//	}
	public List<SportsActivityTeacherDto> getSportsDatas() {
		return SportsDatas;
	}
	@JsonProperty("SportsData")
	public void setSportsDatas(List<SportsActivityTeacherDto> sportsDatas) {
